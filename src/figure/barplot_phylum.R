...
colnames(phylum_abundance.df) <- gsub(
  "_trimmed_filtered_split$",
  "",
  colnames(phylum_abundance.df)
)
...
###Step3.Calculate replicate mean
...
phylum_colors <- c(
  "Firmicutes" = "#6E94A6",
  "Bacteroidota" = "#243B5A",
  "Actinobacteriota" = "#7E8F4D",
  "Proteobacteria" = "#1F5B4A",
  "Verrucomicrobiota" = "#E08B6D",
  "Desulfobacterota" = "#B74C2E",
  "Cyanobacteria" = "#D89A9A",
  "Elusimicrobiota" = "#8C6A4F"
)
...
ggsave("/Users/celina/Desktop/project/16s_metagenomics/results/figures/phylum_barplot24.pdf", p, width = 11.5, height = 8, dpi = 300)
